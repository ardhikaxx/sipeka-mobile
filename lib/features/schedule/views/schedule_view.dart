        ...
        children: [
          ...
          SafeArea(
            child: Column(
              ...
              children: [
                const Padding(padding: EdgeInsets.symmetric(horizontal: 20, vertical: 16), child: Text('Jadwal Periksa', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold))),
                Expanded(
                  child: ListView(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Row(children: [Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: AppColors.bgApp, shape: BoxShape.circle), child: const Icon(Icons.location_on, color: AppColors.primary, size: 16)), const SizedBox(width: 12), Expanded(child: Text(location, style: const TextStyle(color: AppColors.gray700, fontSize: 14)))]),
                const SizedBox(height: 12),
                Row(children: [Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: AppColors.bgApp, shape: BoxShape.circle), child: const Icon(Icons.medical_services, color: AppColors.primary, size: 16)), const SizedBox(width: 12), Expanded(child: Text(doctor, style: const TextStyle(color: AppColors.gray700, fontSize: 14)))]),
              ],
            ),
          ),
        ],
